...
class SpoonFormDate extends SpoonFormInput
{
	...
	public function getTimestamp($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null)
	{
		...
		if($this->isFilled())
		{
			...
			{
				// define long mask
				$longMask = str_replace(array('d', 'm', 'Y'), array('dd', 'mm', 'yy'), (string) $this->mask);
	...
	public function isValid($error = null)
	{
		...
		if($this->isFilled())
		{
			...
			{
				// define long mask
				$longMask = str_replace(array('d', 'm', 'y', 'Y'), array('dd', 'mm', 'y', 'yy'), (string) $this->mask);
	...
	public function setMask($mask = null)
	{
		...
		$maskCorrected = str_replace(array('d', 'm', 'y', 'Y'), array('dd', 'mm', 'y', 'yy'), (string) $maskCorrected);
